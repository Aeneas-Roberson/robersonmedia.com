          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-black/30 backdrop-blur-sm rounded-xl border border-green-500/30 p-8 text-center">
              ...
              <p className="text-gray-300 mb-6">
                Your Instagram data deletion request has been successfully processed. 
          ...
          <div className="bg-black/30 backdrop-blur-sm rounded-xl border border-purple-500/30 p-8 space-y-8">
            ...
            <section>
              <p className="text-gray-300 text-lg leading-relaxed">
                Roberson Media respects your privacy and provides clear instructions for requesting the deletion of your data associated with our Instagram integration services.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed mt-4">
                If you have previously authorized our application to access your Instagram Business account and you wish to revoke that access or request deletion of any related data, please follow the steps below:
              </p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-purple-400 mb-4 flex items-center">
                ...
                Revoke App Access via Instagram Settings
              </h2>
              <p className="text-gray-300 mb-4">
                You may remove this application's access to your Instagram account at any time by:
              </p>
              <ol className="space-y-3 ml-6">
                <li className="text-gray-300 flex items-start">
                  <span className="text-purple-400 mr-3 mt-1 font-bold">1.</span>
                  Going to Instagram Settings → Privacy and Security → Apps and Websites
                </li>
                <li className="text-gray-300 flex items-start">
                  <span className="text-purple-400 mr-3 mt-1 font-bold">2.</span>
                  Locating the application "Roberson Media Instagram Integration"
                </li>
                <li className="text-gray-300 flex items-start">
            ...
            <section>
              ...
              <ul className="space-y-3 ml-6">
                <li className="text-gray-300 flex items-start">
                  ...
                  The Instagram Business account username used with our service
                </li>
                <li className="text-gray-300 flex items-start">
                  <span className="text-purple-400 mr-3 mt-2">•</span>
            ...
            <section>
              ...
              <p className="text-gray-300 mb-4">
                Instagram may also automatically request data deletion on your behalf through their GDPR compliance system. When this happens:
              </p>
              <ul className="space-y-3 ml-6">
                <li className="text-gray-300 flex items-start">
                  <span className="text-purple-400 mr-3 mt-2">•</span>
                  We receive an automated deletion request from Instagram
                </li>
                <li className="text-gray-300 flex items-start">
                  <span className="text-purple-400 mr-3 mt-2">•</span>
              ...
              <div className="mt-4 p-4 bg-pink-900/20 border border-pink-500/30 rounded-lg">
